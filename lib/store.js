...
export function StoreProvider({ children }) {
  const [state, setState] = useState({ loading: true, me: null, households: [], arrangements: [], notifications: [], invites: [] });
  ...
  const refresh = useCallback(async () => {
    ...
    const [profileQ, houseQ, arrQ, notifQ, inviteQ] = await Promise.all([
