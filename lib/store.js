...
// What children see for a side of an arrangement (e.g. "Dad" / "Mom").
export function kidSideName(arr, side) {
  if (side === 'h') return arr.kid_h_label || sideName(arr, 'h');
  return arr.kid_c_label || sideName(arr, 'c');
}
